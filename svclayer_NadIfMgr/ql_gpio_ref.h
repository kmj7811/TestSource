...
#define __QL_GPIO_H__
    ...
    || defined(__QUECTEL_PROJECT_AG35CEN__) || defined(__QUECTEL_PROJECT_AG35E__)
typedef enum{
	...
	#if 0  // FEATURE_DIGEN_GPIO_CONTROL future todo
	/*PIN-161*/ PINNAME_GPIO8 = 161,
	#else
	/*PIN-163*/ PINNAME_GPIO8 = 163,
	/*PIN-165*/ PINNAME_GPIO9 = 165,
	/*PIN-164*/ PINNAME_GPI11 = 164,	
	#endif
